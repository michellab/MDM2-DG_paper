...
export OPENMM_PLUGIN_DIR=/export/users/michalis/sire-2019.app/lib/plugins/

srun /export/users/michalis/sire-2019.app/bin/somd-freenrg -C ../../input/sim-extend.cfg -l $lam -p OpenCL
cd ..
